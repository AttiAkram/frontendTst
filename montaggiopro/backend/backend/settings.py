...
DEBUG = config("DEBUG", default=True if "backend.wsgi" not in sys.argv else False, cast=bool)
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis-svc.developing:6379" if DEBUG else "redis://redis-svc.production:6379",
    }
}
